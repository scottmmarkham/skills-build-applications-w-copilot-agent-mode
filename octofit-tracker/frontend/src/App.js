      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-primary mb-4 octofit-navbar">
        <div className="container-fluid">
          <Link className="navbar-brand d-flex align-items-center" to="/">
            <img src="/octofitapp-small.png" alt="Octofit Logo" width="40" height="40" className="me-2" style={{background: 'white', borderRadius: '50%'}} />
          ...
          <Route path="/" element={
            <div className="p-5 mb-4 bg-light rounded-3">
              <div className="container-fluid py-5">
                ...
                <p className="col-md-8 fs-4">Track your fitness, join teams, compete on the leaderboard, and get personalized workout suggestions.</p>
